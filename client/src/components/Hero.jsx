  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl '>
            ...
            <p className='mb-8 max-w-xl mx-auto text-sm font-light px-5'>Your Next Big Carrer Move Starts Right Here-Explore The Best Job Opportunities And Take The First Step Toward Your Future!</p>
        ...
        {/* this is for the showcase of the trusted bands */}
