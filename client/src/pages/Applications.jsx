  ...
  return (
    <>
     ...
     <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
      <h2 className='text-xl font-semibold cursor-pointer'>Your Resume</h2>
      <div className='flex gap-2 mb-6 mt-3'>
         {
          ...
          ? <>
           ...
           <button onClick={e => setIsEdit(false)} className='bg-green-100 border border-green-400 rounded-lg px-4 py-2 cursor-pointer'>Save</button>
          </>
